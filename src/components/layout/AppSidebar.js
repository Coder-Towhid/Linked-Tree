...
export default function AppSidebar() {
    ...
    return (
        <nav className="inline-flex mx-auto flex-col text-center mt-12 gap-6 text-gray-500">
            ...
            <Link href={'/account'} className={`flex gap-4     ${path === '/account' ? ' text-blue-500' : ''}`}>
            ...
            <LogoutButton iconClasses={'w-6 h-6'} iconLeft={true} classname={'flex gap-4 items-center text-gray-500'} />
